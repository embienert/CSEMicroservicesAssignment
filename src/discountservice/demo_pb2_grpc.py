...
class DiscountServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetDiscount = channel.unary_unary(
                '/hipstershop.DiscountService/GetDiscount',
                request_serializer=demo__pb2.DisRequest.SerializeToString,
                response_deserializer=demo__pb2.DisResponse.FromString,
                )
        self.UpdateSales = channel.unary_unary(
                '/hipstershop.DiscountService/UpdateSales',
                request_serializer=demo__pb2.UpdateRequest.SerializeToString,
                response_deserializer=demo__pb2.UpdateResponse.FromString,
                )
...
def add_DiscountServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetDiscount': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=demo__pb2.DisRequest.FromString,
                    response_serializer=demo__pb2.DisResponse.SerializeToString,
            ),
            'UpdateSales': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateSales,
                    request_deserializer=demo__pb2.UpdateRequest.FromString,
                    response_serializer=demo__pb2.UpdateResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'hipstershop.DiscountService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class DiscountService(object):
    ...
    def GetDiscount(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hipstershop.DiscountService/GetDiscount',
            demo__pb2.DisRequest.SerializeToString,
            demo__pb2.DisResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UpdateSales(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hipstershop.DiscountService/UpdateSales',
            demo__pb2.UpdateRequest.SerializeToString,
            demo__pb2.UpdateResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
